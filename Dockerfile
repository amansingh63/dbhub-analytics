...
# - --filter=dbhub-analytics: Only deploy dependencies for the main package (not frontend)
...
COPY --from=builder /prod/dbhub-analytics/node_modules ./node_modules
COPY --from=builder /prod/dbhub-analytics/package.json ./
